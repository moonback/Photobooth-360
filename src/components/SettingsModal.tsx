        ...
        <div className="px-6 py-6 space-y-7 overflow-y-auto max-h-[65vh]">
            ...
            <div className="flex flex-wrap gap-2">
              {DURATIONS.map(({ value, label }) => (
                <button
                  key={value}
                  type="button"
                  aria-pressed={local.duration === value}
            ...
            <div className="flex flex-wrap gap-2">
              {COUNTDOWNS.map(({ value, label }) => (
                <button
                  key={value}
                  type="button"
                  aria-pressed={local.countdownSeconds === value}
          ...
          <section className="space-y-3">
            ...
            <div className="flex gap-2">
              <button
                type="button"
                aria-pressed={local.facingMode === "user"}
              ...
              <button
                type="button"
                aria-pressed={local.facingMode === "environment"}
          ...
          <section className="space-y-3">
            ...
            <button
              type="button"
              aria-pressed={local.recordAudio}
            ...
            <div className="flex flex-col gap-2">
              {RESOLUTIONS.map(({ value, label, width, height }) => (
                <button
                  key={value}
                  type="button"
                  aria-pressed={local.resolution === value}
            ...
            <div className="flex gap-3">
              {ACCENT_COLORS.map(({ value, label, class: cls }) => (
                <button
                  ...
                  aria-pressed={local.accentColor === value}
