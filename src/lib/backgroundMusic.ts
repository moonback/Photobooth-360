...
export const BACKGROUND_TRACKS: BackgroundTrack[] = [
  { id: 'track1', label: 'Énergique', file: '/song/track1.mp3' },
  { id: 'track2', label: 'Chill', file: '/song/track2.mp3' },
  { id: 'track3', label: 'Festif', file: '/song/track3.mp3' },
  { id: 'track4', label: 'Élégant', file: '/song/track4.mp3' },
  { id: 'track5', label: 'Dynamique', file: '/song/track5.mp3' },
];
