...
export type LogoUploadStatus = 'idle' | 'uploading' | 'done' | 'error';

export interface LogoUploadResult {
  /** Public URL of the uploaded logo */
  publicUrl: string;
  /** Storage path, e.g. "logos/abc123.png" */
  path: string;
}

/**
 * Upload a logo image file to the `photobooth-logos` Supabase bucket.
