  ...
  return (
    <main className="relative h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <div className="relative flex h-screen min-h-0 flex-col p-4 sm:p-6 lg:p-8">
        <header className="mb-4 flex shrink-0 flex-wrap items-center justify-between gap-3 rounded-[1.75rem] border border-white/10 bg-white/[0.07] px-4 py-3 shadow-2xl shadow-black/30 backdrop-blur-2xl sm:px-5 lg:mb-5">
        ...
        {capture ? (
          <section className="grid min-h-0 flex-1 items-stretch gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(320px,360px)] xl:grid-cols-[minmax(0,1fr)_380px]">
            <div className="relative h-full min-h-[42vh] overflow-hidden rounded-[2.25rem] border border-white/10 bg-black shadow-2xl shadow-indigo-950/40 lg:min-h-0">
              <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.10),transparent_24%,transparent_72%,rgba(34,211,238,0.10))]" />
              <video
            ...
            <aside className="flex min-h-0 flex-col justify-between overflow-y-auto rounded-[2.25rem] border border-white/10 bg-white/[0.075] p-4 text-center shadow-2xl shadow-black/30 backdrop-blur-2xl xl:p-5">
              <div>
                <div className="mx-auto mb-3 grid h-14 w-14 place-items-center rounded-3xl bg-gradient-to-br from-emerald-400/25 to-cyan-400/20 text-emerald-100 ring-1 ring-white/10 xl:mb-4 xl:h-16 xl:w-16">
              ...
              <div className="mx-auto my-4 w-full max-w-[min(280px,34vh)] rounded-[2rem] border border-white/10 bg-white p-3 shadow-[0_0_50px_rgba(34,211,238,0.18)] xl:my-6 xl:max-w-[300px] xl:p-4">
